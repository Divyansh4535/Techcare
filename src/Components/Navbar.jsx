...
const Navbar = () => {
    const list = [
        {
            title: "Overview",
            icon: <svg xmlns="http://www.w3.org/2000/svg" width="15.509" height="17" viewBox="0 0 15.509 17">
        ...
        {
            title: "Patients",
            icon: <svg xmlns="http://www.w3.org/2000/svg" width="23.733" height="17" viewBox="0 0 23.733 17">
            ...
            className: "bg-[#01F0D0] rounded-full h-[41px] w-[122px] text-center "
        },
        {
            title: "Schedule",
            icon: <svg xmlns="http://www.w3.org/2000/svg" width="15.119" height="17" viewBox="0 0 15.119 17">
            ...
            title: "Message",
            icon: <svg xmlns="http://www.w3.org/2000/svg" width="18.695" height="17" viewBox="0 0 18.695 17">
            ...
            title: "Transactions",
            icon: <svg xmlns="http://www.w3.org/2000/svg" width="21.533" height="17" viewBox="0 0 21.533 17">
        ...
        <div className='h-[70px] w-[98%]   flex items-center justify-center '>
            <nav className='flex  items-center justify-between h-full w-[99%] rounded-full  bg-[#FFFFFF] px-5'>
                ...
                <div className='flex items-center  gap-2 px-3 justify-between '>
                    ...
                    <div className='flex items-start border-r border-gray-200 justify-start leading-1 flex-col px-3'>
                        <p className='text-[14px] font-bold '>Dr. Jose Simmons</p>
                        <p className='text-[#707070] text-[14px] font-normal'> General Practitioner</p>
                    </div>
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="18.944" height="20" viewBox="0 0 18.944 20">
